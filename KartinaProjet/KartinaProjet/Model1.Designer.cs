<<<<<<< HEAD
﻿// La génération de code T4 est activée pour le modèle 'C:\Users\utilisateur\source\repos\KartinaProjetFinal\Kartina\KartinaProjet\KartinaProjet\Model1.edmx'. 
...
=======
﻿// La génération de code T4 est activée pour le modèle '\\Mac\Home\Documents\2. Programmation AJC C sharp\Projet YellowKorner\KartinaRepo\KartinaProjet\KartinaProjet\Model1.edmx'. 
// Pour activer la génération de code héritée, définissez la valeur de la propriété
// du concepteur 'Stratégie de génération de code' sur 'ObjectContext hérité'. Cette propriété est disponible dans la fenêtre Propriétés lorsque le modèle
//  est ouvert dans le concepteur.
